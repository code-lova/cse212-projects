...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Incorrect order of dequeueing: The first person (Bob) is not dequeued as expected; instead, Sue is dequeued first.
    // Error: Assert.AreEqual failed. Expected<Bob>. Actual:<Sue>
    ...
    // Defect(s) Found: 
    // Defect(s) Found: The queue does not properly maintain the expected order of people being dequeued.
    // Error: Assert.AreEqual failed. Expected<Bob>. Actual:<Sue>
    ...
    // Defect(s) Found: The queue does not properly maintain the expected order of people being dequeued.
    // Error: Assert.AreEqual failed. Expected<Tim>. Actual:<Sue>
