public class SimpleQueue {
    public static void Run() {
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Resolved - _queue.Insert(0, value) doesn't follow FIFO rules instead use _queue.Add(value)
        ...
        // Defect(s) Found: Resolved - _queue[1] target index(1), which is not the first index in the queue instead we do
                            // _queue[0] and _queue.RemoveAt(0); not _queue.RemoveAt(1);
        Console.WriteLine("------------");
    }
